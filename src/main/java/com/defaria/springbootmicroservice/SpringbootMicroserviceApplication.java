package com.defaria.springbootmicroservice;

import com.defaria.springbootmicroservice.domain.Difficulty;
import com.defaria.springbootmicroservice.domain.Region;
import com.defaria.springbootmicroservice.services.TourPackageService;
import com.defaria.springbootmicroservice.services.TourService;
...
public class SpringbootMicroserviceApplication implements CommandLineRunner {
    ...
    private static class TourFromFile {
        //fields
        private String packageType, title, description, blurb, length,
                bullets, keywords, region;
