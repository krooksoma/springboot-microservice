package com.defaria.springbootmicroservice.controllers;
...
import com.defaria.springbootmicroservice.dto.RatingDto;
import com.defaria.springbootmicroservice.repositories.TourRatingRepository;
import com.defaria.springbootmicroservice.repositories.TourRepository;
...
public class TourRatingController {
    ...
    private Tour verifyTour(int tourId) throws NoSuchElementException{
        return tourRepository.findById(tourId).orElseThrow(()->
                new NoSuchElementException("Tour with given does not exist. Id: " + tourId));
    }

    //Exception handler if NoSuchElementException is thrown. 404
